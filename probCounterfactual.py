...
p_A = Prob(A, [], [0.5,0.5])
p_B = Prob(B, [A, BifA, BifnA], [[[[1,0],[0,1]],[[1,0],[0,1]]], # A=0
                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # A=1
p_C = Prob(C, [B, CifB, CifnB], [[[[1,0],[0,1]],[[1,0],[0,1]]], # B=0
                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # B=1
p_Aprime = Prob(Aprime,[], [0.6,0.4])
p_Bprime = Prob(Bprime, [Aprime, BifA, BifnA], [[[[1,0],[0,1]],[[1,0],[0,1]]], # A=0
                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # A=1
p_Cprime = Prob(Cprime, [Bprime, CifB, CifnB], [[[[1,0],[0,1]],[[1,0],[0,1]]], # B=0
                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # B=1
p_bifa = Prob(BifA, [], [0.6,0.4])  # Does not actually depend on A!!!
...
#p_S1 = Prob(S1, [Order, S1o, S1n], [[[[1,0],[0,1]],[[1,0],[0,1]]], # Order=0
#                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # Order=1
#p_S2 = Prob(S2, [Order, S2o, S2n], [[[[1,0],[0,1]],[[1,0],[0,1]]], # Order=0
#                                     [[[1,0],[1,0]],[[0,1],[0,1]]]]) # Order=1
